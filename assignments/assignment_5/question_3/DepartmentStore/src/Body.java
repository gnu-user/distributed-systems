...
public class Body {
	...
	public static String SessionId = "<h2 id=\"id\">";
	public static String SessionIdEnd = "</h2>";
	...
	public static String getHTMLPage(int id, String entries)
	{
		if(entries == null)
		{
			entries = content;
		}
		String HTML = HTML_PAGE_HEAD + SessionId + String.valueOf(id) + SessionIdEnd + LIST_CONTENT + entries + LIST_END + HTML_PAGE_FOOTER;
		return HTML;
	}
}
